...
The source code of the [static HTML](https://github.com/LonelyCpp/react-native-youtube-iframe/blob/master/iframe.html) is minified and uploaded as a part of the documentation website [here](https://hyochan.github.io/youtube_iframe/).
